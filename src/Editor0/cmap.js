...
;(() => {
	...
	cmapText[TodoItem.type]             = data => toInnerString(data.children)
	...
	cmapReact_js[TodoItem.type]         = data => `<Item>\n\t<Todo${!data.checked.value ? "" : " done"} />\n\t${toInnerString(data.children, cmapReact_js)}\n</Item>`
