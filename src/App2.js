						...
						<div className="rounded-lg shadow-lg">
							<Button className="px-4 py-3 flex flex-row items-center bg-black font-medium text-white rounded-lg shadow-lg pointer-events-auto" onClick={editorPrefsDispatch.toggleReadOnly}>
								<svg className="mr-2 w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
									...
									<path d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" fill-rule="evenodd"></path>
								</svg>
								Preview mode
